...
void TFT::lcd_draw_line_fast(uint16_t hwXpos0, //specify x0 position.
                      uint16_t hwYpos0, //specify y0 position.
                      uint16_t hwXpos1, //specify x1 position.
                      uint16_t hwYpos1, //specify y1 position.
                      uint16_t hwColor) //specify the color of the line
{
    ...
    for (;;) {
		...
		__LCD_DC_SET();
		__LCD_WRITE_BYTE(hwXpos0);
		__LCD_DC_CLR();
		__LCD_WRITE_BYTE(0x03);
		__LCD_DC_SET();
		__LCD_WRITE_BYTE(hwXpos0 & 0xFF);
		__LCD_DC_CLR();
		__LCD_WRITE_BYTE(0x06);
		__LCD_DC_SET();
		__LCD_WRITE_BYTE(hwYpos0 >> 8);
		__LCD_DC_CLR();
		__LCD_WRITE_BYTE(0x07);
		__LCD_DC_SET();
		__LCD_WRITE_BYTE(hwYpos0 & 0xFF);
		__LCD_DC_CLR();
		__LCD_WRITE_BYTE(0x22);
		__LCD_DC_SET();
...
void TFT::lcd_fill_rect_fast(uint16_t hwXpos,  //specify x position.
                   uint16_t hwYpos,  //specify y position.
                   uint16_t hwWidth, //specify the width of the rectangle.
                   uint16_t hwHeight, //specify the height of the rectangle.
                   uint16_t hwColor)  //specify the color of rectangle.
